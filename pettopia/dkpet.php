...
if (isset($_POST['pet_name'])) {
    ...
    $id_customer = $_POST['customer_name']; // Changed from 'IDCustomer' to 'customer_name'

    if (empty($pet_name)) {
        $error = 'Tên thú cưng không được để trống';
    }
...
<div class="panel panel-primary">
    <div class="panel-heading">
        <h3 class="panel-title">Đăng ký thú cưng</h3>
    </div>
